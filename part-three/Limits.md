...
随着数字技术的发展，我们看到了一个向更大的市场力量和财富集中的转变。当你绘制一些数字曲线时，例如按收入计算的公司，这些曲线看起来像所谓的 “指数法则”（幂律）：最大的公司比下一个最大的公司大得多，而下一个公司又比第三大公司大得多，以此类推。这种模式普遍存在于整个数字技术和它发挥主要作用的行业。例如，YouTube 上观看次数最多的视频已经被观看了数十亿次，而绝大多数的视频只被观看了几次。在电子商务领域，亚马逊比其最大的竞争对手大一个数量级，比大多数电子商务公司大几个数量级。应用程序也是如此：领先的应用程序有数以亿计的用户，但绝大多数的应用程序只有几个。
